...
class DailyQuestionListView(CustomResponseMixin, generics.ListAPIView):
    ...
    queryset = DailyQuestion.objects.all().select_related('question').prefetch_related(
    ...
    def list(self, request, *args, **kwargs):
        ...
        return self.get_paginated_response(serializer.data) if page is not None else self.success_response(
